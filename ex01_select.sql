...
열 alias 정의 - 별명
    열 머리글의 이름을 바꿉니다.
    열 이름 바로 뒤에 나옵니다.(열 이름과 alias 사잉에 선택 사항인 as 키워드가 올수 있습니다.)
...
리터럴 문자열
    ...
    날짜 및 문자 리터럴 값은 작은 따옴표로 묶어야 됩니다.
...
/*
중복행 
    기복적으로 Query 결과에는 중복 행을 포함한 모든행이 표시됩니다.
...
/*
테이블 구조표시
    DESCRIBE 명령을 사용하여 테이블 구졸르 표시합니다.
*/
DESCRIBE employees;
